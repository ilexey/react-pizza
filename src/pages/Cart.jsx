...
function Cart() {
  ...
  const onClearCart = () => {
    let confirmQuestion = window.confirm("Вы действительно хотите очистить корзину?");
    if (confirmQuestion) {
      dispatch(clearCart());
    }
  };
  ...
  const onRemoveItem = (id) => {
    let confirmQuestion = window.confirm("Вы действительно хотите удалить пиццу?");
    if (confirmQuestion) {
      ...
      <div className="container container--cart">
        {
          totalCount
            ? <div className="cart">
              ...
              <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons">
                  <div className="button button--outline button--add go-back-btn" onClick={() => router('/')}>
            ...
            : <div className="cart cart--empty">
              ...
              <div className="button button--black" onClick={() => router('/')}>
                <span>Вернуться назад</span>
              </div>
            </div>
        }
